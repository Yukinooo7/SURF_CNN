...
src = cv.imread('E:\\Study\\2019-Summer\\SURF\\python\\Contours\\07121240.jpg')
print(src.shape)
cv.namedWindow('input_image', cv.WINDOW_AUTOSIZE)
cv.imshow('input_image', src)
line_detection(src)
src = cv.imread('E:\\Study\\2019-Summer\\SURF\\python\\Contours\\07121240.jpg')  # 调用上一个函数后，会把传入的src数组改变，所以调用下一个函数时，要重新读取图片
